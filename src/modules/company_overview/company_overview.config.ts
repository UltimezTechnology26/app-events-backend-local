...
/** report_list_type=2's valuation/organizers pipelines also need the event-date match stage. */
export interface OverviewEventContext extends OverviewPipelineContext {
  matchQuery: Record<string, unknown>
}

/** report_list_type=2's sponsor/partner pipelines additionally branch on sponsor (1) vs partner (2). */
export interface OverviewSponsorPartnerContext extends OverviewEventContext {
  sponsorPartnerType: number
}

/** report_list_type=6's per-product-type count pipelines (cryptocurrency/blockchain/exchange). */
export interface OverviewProductCountContext extends OverviewPipelineContext {
  productType: number
}

/** Minimal shape this config map actually calls on `model` — every entry is a Mongoose model required via `require(...)`. */
export interface AggregatableModel {
  aggregate: (pipeline: Record<string, unknown>[]) => Promise<unknown[]>
}

export interface ReportTypeConfigEntry {
  model: AggregatableModel
  buildPipeline: (ctx: OverviewPipelineContext) => Record<string, unknown>[]
}
...
export function buildType3ValuationPipeline({ isPartner, searchQuery }: OverviewPipelineContext) {
  return [
                    {
                        $match: {
...
export function buildType3FundsRaisedPipeline({ isPartner, searchQuery }: OverviewPipelineContext) {
  return [
                    {
                        $match: {
                            funds_raised_registered_type: 1, verified_status: 1
...
export function buildType5ValuationPipeline({ isPartner, searchQuery }: OverviewPipelineContext) {
  return [
                    {
                        $sort: {
                            year: -1,
...
export function buildType5RevenuePipeline({ isPartner, searchQuery }: OverviewPipelineContext) {
  return [
                    {
                        $sort: {
                            year: -1,
...
export function buildType7ValuationPipeline({ isPartner, searchQuery }: OverviewPipelineContext) {
  return [
                    {
                        $match: {
                            company_type: 1
...
export function buildType7HoldingPipeline({ isPartner, searchQuery }: OverviewPipelineContext) {
  return [
                    {
                        $match: {
                            company_type: 1
...
export function buildType4ValuationPipeline({ isPartner, searchQuery }: OverviewPipelineContext) {
  return [
                    {
                        $match: {
...
export function buildType4InvestedPipeline({ isPartner, searchQuery }: OverviewPipelineContext) {
  return [
                    {
                        $match: {
                            investor_type: 2, investor_registered_type: 1, verified_status: 1
...
export function buildType4RoundsPipeline({ isPartner, searchQuery }: OverviewPipelineContext) {
  return [
                    {
                        $match: {
                            investor_type: 2, investor_registered_type: 1, verified_status: 1
...
export function buildType6ValuationPipeline({ isPartner, searchQuery }: OverviewPipelineContext) {
  return [
...
export function buildType6ProductCountPipeline({ isPartner, searchQuery, productType }: OverviewProductCountContext) {
  return [
...
export function buildType2ValuationPipeline({ isPartner, searchQuery, matchQuery }: OverviewEventContext) {
  return [
                    {
                        $match: {
                            active_status: 1,
...
export function buildType2OrganizersPipeline({ isPartner, searchQuery, matchQuery }: OverviewEventContext) {
  return [
                    {
                        $match: {
                            active_status: 1,
...
export function buildType2SponsorPartnerPipeline({ isPartner, searchQuery, sponsorPartnerType, matchQuery }: OverviewSponsorPartnerContext) {
  return [
                    {
                        $match: {
                            active_status: 1,
 ...
 */
export function buildType8ValuationPipeline({ isPartner, searchQuery }: OverviewPipelineContext) {
  return [
