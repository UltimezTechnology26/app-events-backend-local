...
export const getRegulatoriesList = async (companyRowIdParam: string | undefined) => {
...
interface RegexMatchCondition {
    $regex: string
    $options: string
}

export const getRegulatoriesTypesList = async (search: string | undefined) => {
    const matchStage: { regulator_type_name?: RegexMatchCondition } = {};
    if (search?.trim()) {
...
export const getRegulatoriesBodyList = async (search: string | undefined) => {
    const matchStage: { regulatory_bodies_name?: RegexMatchCondition } = {};
 ...
 * getIds above.
 */
export const getBodyType = async (bodyIdParam: string) => {
