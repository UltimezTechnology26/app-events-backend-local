...
// add_n_update_details/delete/job_status moved to src/modules/jobs/jobs.controller.ts (jobsRouter,
// mounted alongside this router at the same '/job' prefix in routes/app.js) so the admin-actor
// write path can go through change-request review - see that module's own doc comments. This
// file keeps only its remaining read-only routes below (list/education_type_list/skill_list),
// deliberately left unmigrated (no write path, out of scope for the review gate).
