...
// 'cln_static_user_designations'). This file stays as a passthrough so every other call site
// (including `professionals`/`professionals-approvals`) keeps working unchanged.
module.exports = require('../../../src/modules/system_settings/system_settings.models').UserDesignationsM
